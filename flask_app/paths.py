...
COMBADGE_PATH_V1 = os.path.join(
    os.path.dirname(__file__), "..", "webapp", "dist", "assets", "combadge.py"
)
...
def get_combadge_path(combadge_version, *, os_type):
    ...
    return os.path.join(
        COMBADGE_ASSETS_DIR, combadge_version, f"combadge_{os_type}", asset_name
    )
